...
class CreateUserForm(UserCreationForm):
    ...
    email = forms.EmailField(max_length=200, label="Enter your email", widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Enter your email'}))
    password1 = forms.CharField(max_length=200, label="Enter a password", widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Enter a password'}))
